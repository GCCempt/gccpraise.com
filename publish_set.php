...
<body>
<div id="header"><img src="images/gcclogo.gif" alt="gcc logo"></div>
...
echo $menu;
$dir1 = "sets/";  //sets directory
$dir2 = "songs/";   //songs (xml) directory
$setdir = opendir($dir1);
...
{
//	echo "<pre> Function Input Presentation Order: "; print_r($presentation); echo "</pre>";    //print presentation order array
//	echo "<pre> Function Input Song Sections: "; print_r($array); echo "</pre>";    //print song section array
...
//	echo "<pre> Function Presentation Array Size: " . $presentationarraysize . "</pre> \n";    //print song section array
    ...
    if (empty($presentation)) //	if($presentationarraysize = 1)  // check for empty presentation order
    {
        $i = 0;
        foreach ($array as $p) {
...
//			foreach ($lyrics as $element) // loop through the lyrics
            for ($x = $key + 1; $x <= $lyricsarraysize - 1; $x++) {
