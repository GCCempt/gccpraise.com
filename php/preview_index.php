...
$song = "";
$song2 = "";
$videolink = "<iframe width=\"420\" height=\"315\" src=\"//www.youtube.com/embed/user1?rel=0\" frameborder=\"0\"  allowfullscreen></iframe>";
$videolink2 = "<iframe width=\"420\" height=\"315\" src=\"//www.youtube.com/embed/user2?rel=0\" frameborder=\"0\"  allowfullscreen></iframe>";
$listing = "";
$alpha = "";
$preview = "All In All";
$s = false;
...
foreach ($files as $f)
{
	if ($s)
	{
		...
		{
			$searchresults .= '<li><a href="preview_index.php?s=' . $f . '">' . $f .
	'</a> <a href="javascript:void(0)" onclick="addToSetlist(\'' . str_replace(" ", "_", $f) . '\')"></a> </li>';
		}
	}
	$letter = substr($f, 0, 1);
	if ($letter!=$last)
	...
	$listing .=  '<li><a href="preview_index.php?s=' . $f . '">' . $f .
	'</a> <a href="javascript:void(0)" onclick="addToSetlist(\'' . str_replace(" ", "_", $f) . '\')"></a> </li>';
	$last = $letter;
}
?>
<div id="header"><img src="images/gcclogo.gif" />
<div id="menu"><a href="http://gccpraise.com/praise-team/">Praise Team Home</a> <a href="https://docs.google.com/spreadsheets/d/1_FAwmbf0nH7_qV2MJVWeMRbm--1I_AdLFlaFOXtl8U0/edit#gid=0" TARGET="_blank">Worship Schedule</a> <a href="http://gccpraise.com/os-viewer/preview_set.php" TARGET="_blank">Worship Sets</a></div>
</div>
